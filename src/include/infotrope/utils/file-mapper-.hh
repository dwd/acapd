...
#ifdef _REENTRANT
#include "threadrwlock.hh"
#endif

#include "filemapper-ptr.hh"
...
namespace Utils {
  ...
  namespace MMap {
	...
	if( !m_master ) {
	  ...
	  m_master = ::Utils::MMap::get_allocator<master_allocator>( n2, m_id );
	}
	...
	filemapper_ptr<master_allocator> alloc( ::Utils::MMap::get_allocator<master_allocator>( n2, p.m_locality ) );
